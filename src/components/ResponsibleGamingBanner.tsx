...
export const ResponsibleGamingBanner: React.FC<ResponsibleGamingBannerProps> = ({
  ...
  return (
    <aside
      ...
      className="bg-slate-950/95 border-b border-amber-500/20 text-amber-300/90 text-[11px] py-1 px-3 sm:px-6 relative z-30 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 whitespace-nowrap overflow-x-auto no-scrollbar">
        <div className="flex items-center gap-2 min-w-0">
          <span className="shrink-0 px-1 py-0.2 rounded bg-amber-500 text-slate-950 font-black text-[9px] tracking-wider uppercase leading-none">
            18+ ONLY
          </span>
          <span className="truncate text-[10.5px] text-slate-300 font-normal">
