    ...
    <div id="filter-control-panel" className="mb-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-900/80 p-3 rounded-2xl border border-slate-800">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-1 max-w-md">
          <div className="relative w-full">
            <input
              ...
              className="w-full bg-slate-950 text-slate-100 placeholder-slate-400 text-xs sm:text-sm pl-9 pr-8 py-2 rounded-xl border border-slate-700/70 focus:outline-hidden focus:border-amber-400"
            />
        ...
        <div className="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto">
          ...
          <span className="text-xs text-slate-400 font-medium whitespace-nowrap hidden md:inline">
            Showing <strong className="text-amber-400 font-bold">{totalCount}</strong> Yono Apps
          </span>
          ...
          <div className="flex items-center gap-1.5 bg-slate-950 px-2.5 py-1.5 rounded-xl border border-slate-800 text-xs">
            ...
            >
              ...
              <option value="bonus_high" className="bg-slate-900">💰 Highest Bonus</option>
              <option value="withdrawal_low" className="bg-slate-900">⚡ Lowest Min W/D</option>
              <option value="rating" className="bg-slate-900">⭐ Highest Rating</option>
              <option value="newest" className="bg-slate-900">🆕 Latest 2026</option>
            </select>
          </div>
